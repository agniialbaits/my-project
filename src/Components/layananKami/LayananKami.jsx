                ...
                <div class="content">
                    ...
                    <div class="search-box">
                        <div class="search-combined">
                            <div class="dropdown">
                                <img src="/home.png" alt="icon rumah" class="icon-img"/>
                                    <span class="text">Tipe rumah</span>
                                    <img src="/dropdown.png" alt="dropdown" class="dropdown-arrow"/>
                                    </div>
                                    <div class="location">
                                        <img src="/lokasi.png" alt="icon lokasi" class="icon-img"/>
            ...
            {/* <!-- MAU JUAL RUMAH --> */}
             <section class="jual-rumah">
                ...
                <div class="whatsapp-button">
                    <img src="/wa.png" alt="whatsapp"/>Whatsapp kami sekarang
                </div>
            </section> 
        </div>
    );
